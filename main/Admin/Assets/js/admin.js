 ...
 *  # Template JS Admin
 *
 *  Incluye los controles para que funcione el template
 *
 * ---------------------------------------------------------------------------- */
...
var Admin = (function () {
    ...
    var _sidebarRightSecondaryToggle = function () {
        $(document).on(
            "click",
            ".sidebar-right-secondary-toggle",
            function (e) {
                e.preventDefault();
    ...
    var _cardActionReload = function () {
        $(".card [data-action=reload]:not(.disabled)").on(
            "click",
            function (e) {
                e.preventDefault();
                var $target = $(this),
    ...
    var _cardActionCollapse = function () {
        $(".card [data-action=collapse]:not(.disabled)").on(
            "click",
            function (e) {
                var target = $(this);
                ...
                target.closest(".card-header").nextAll().slideToggle(150);
            }
        );
    };
