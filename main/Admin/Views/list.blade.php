...
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">{{ $model_info->model_titles[app()->getLocale()]['plural'] }}</h5>
                            ...
                            <div class="controls">
                                <div class="input-group mb-3">
                                    ...
                                    <select style="width: 200px" id="filterlist" class="form-control select2">
                                        ...
                                        @foreach ($model_info->filter as $item)
...
@push('scripts')
    <script>
        ...
        var route_getdata = '{{ route($model_info->routes['getdata']) }}';
